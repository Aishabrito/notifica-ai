...
export default function ComoFunciona() {
  return (
    ...
    >
      ...
      {/* HERO */}
      <section
        className="pt-40 pb-24 px-16 border-b border-white/[0.05] relative overflow-hidden"
        style={{ background: 'radial-gradient(ellipse 70% 60% at 70% 40%, rgba(108,52,131,0.14) 0%, transparent 70%), #0a0a0a' }}
      >
        <Reveal>
          <div className="flex items-center gap-3 mb-6 w-fit px-4 py-1.5 rounded-full border border-purple-500/20 bg-purple-950/30 shadow-[0_0_15px_rgba(108,52,131,0.1)]">
            <span className="font-mono text-[9px] text-purple-200 tracking-widest bg-purple-500/30 px-2.5 py-1 rounded-full uppercase">como funciona</span>
          </div>
          <h1 className="text-7xl font-black tracking-tighter leading-[0.88] mb-8 max-w-3xl">
            Uma coisa só:<br />
      ...
      {/* PARA QUEM É */}
      <section className="px-16 py-24 border-b border-white/[0.05]">
        <Reveal>
          <Label>// para quem é</Label>
          <h2 className="text-5xl font-black tracking-tighter mb-14">Qualquer site.<br />Qualquer mudança.</h2>
        </Reveal>
      ...
      {/* 3 PASSOS */}
      <section
        className="px-16 py-24 border-b border-white/[0.05]"
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-px bg-purple-900/10 rounded-xl overflow-hidden border border-purple-500/10">
          {[
            ...
            <Reveal key={s.n} delay={i * 0.1}>
              <div
                className="p-12 group relative overflow-hidden h-full"
              ...
              >
                ...
                <div className="text-7xl font-black text-purple-950/30 leading-none mb-6 group-hover:text-purple-500/10 transition-colors">{s.n}</div>
                <div className="text-lg font-bold tracking-tight mb-3 group-hover:text-emerald-400 transition-colors">{s.title}</div>
      ...
      {/* NA PRÁTICA */}
      <section className="px-16 py-24 border-b border-white/[0.05] relative overflow-hidden">
        <div className="absolute top-1/2 -translate-y-1/2 left-0 w-[400px] h-[400px] rounded-full blur-[100px] pointer-events-none bg-purple-900/15" />
        <div className="grid grid-cols-2 gap-24 items-center max-w-6xl mx-auto">
          <Reveal>
            <Label>// na prática</Label>
            <h2 className="text-5xl font-black tracking-tighter leading-[0.92] mb-6">
              Você dorme.<br />
              <span
      ...
      {/* STATS */}
      <section className="py-16 px-16 border-b border-white/[0.05] relative overflow-hidden"
        style={{ background: 'radial-gradient(ellipse 60% 80% at 50% 0%, rgba(108,52,131,0.06) 0%, transparent 70%), #0a0a0a' }}
      >
        <Reveal>
            ...
            {[
              ...
              <div key={s.label}>
                <div className="text-4xl font-black tracking-tighter leading-none mb-2">
                  {s.num}<span className="text-purple-400">{s.unit}</span>
                </div>
      ...
      {/* CTA */}
      <section
        className="px-16 py-32 text-center relative overflow-hidden border-t border-white/[0.05]"
      ...
      >
        <Reveal>
          ...
          <p className="text-base text-neutral-500 mb-12 font-light max-w-lg mx-auto leading-relaxed">
          ...
          <Link
            to="/dashboard"
            className="inline-block bg-emerald-400 text-black font-bold text-base px-12 py-5 rounded-sm hover:bg-emerald-300 transition-all hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(16,185,129,0.35)] relative"
          >
