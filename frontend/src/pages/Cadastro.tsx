            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer group py-2">
                ...
                <span className="text-[11px] sm:text-xs text-neutral-500 leading-relaxed font-light">
                  Concordo com os{" "}
                  <Link to="/termos" className="text-purple-400 hover:text-purple-300 transition-colors cursor-pointer">Termos de Uso</Link>{" "}
                  e{" "}
                  <Link to="/privacidade" className="text-purple-400 hover:text-purple-300 transition-colors cursor-pointer">Política de Privacidade</Link>.
                </span>
              </label>
