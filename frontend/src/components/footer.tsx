...
export const Footer = () => (
  <footer className="border-t border-neutral-900 px-6 md:px-16 py-10 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
    ...
    <div className="flex items-center gap-4 font-mono text-xs">
      <Link to="/termos" className="text-purple-400/60 hover:text-purple-300 transition-colors">
        Termos de Uso
      </Link>
      <span className="text-neutral-800">·</span>
      <Link to="/privacidade" className="text-purple-400/60 hover:text-purple-300 transition-colors">
